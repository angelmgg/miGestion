...
public class ParametrosLocal {
	...
	public static String NOMBRE = parametros.getString("LOCAL_NOMBRE");
	...
	public static int POS_IDENTIFICADOR_VISTA_DESDE = 23;
	public static int POS_IDENTIFICADOR_VISTA_HASTA = 24;
	public static int POS_NOMBRE_DDM = 57;
